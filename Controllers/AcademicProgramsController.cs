...
namespace BITCollege_MG.Controllers
{
    public class AcademicProgramsController : Controller
    {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            //Clear method applied to clear relationship between AcademicProgram and Student.
            academicProgram.Student.Clear();

            //Clear method applied to clear relationship between AcademicProgram and Course.
